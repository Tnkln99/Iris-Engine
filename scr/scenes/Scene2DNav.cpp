...
namespace iris::scene{
    ...
    Scene2DNav::Scene2DNav(graphics::ForwardRenderer &renderer, graphics::Window& window) : app::Scene(renderer, window){

    }
    void Scene2DNav::update() {
    ...
    void Scene2DNav::loadScene() {
        initObjects();
        initLights();
    }

    void Scene2DNav::initObjects() {
